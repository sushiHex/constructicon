...
| M8 | [Live executors rev 1](milestones/M8-live-executors-rev1.md) | Draft reconciled against M7.1 closure at `71c4fe3`, existing executor/workspace contracts, and dated primary backend documentation | Review draft; ADR 0018 proposed. Linux-first support, credential delegation, and description schema 3 require approval before implementation |
